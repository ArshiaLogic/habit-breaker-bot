...
1. **Clone the repository:**
   ```bash
   git clone [[https://github.com/your-username/mind-reset-ai.git](https://github.com/your-username/mind-reset-ai.git](https://github.com/ArshiaLogic/habit-breaker-bot.git))
   cd mind-reset-ai
